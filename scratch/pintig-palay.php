            ...
            <div class="container-fluid">
                ...
                <div class="container mt-5">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="procurement-tab" data-bs-toggle="tab" data-bs-target="#procurement" type="button" role="tab" aria-controls="procurement" aria-selected="false">Procurement</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" style="height: 100vh;" id="myTabContent">
